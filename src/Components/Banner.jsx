...
const Banner = () => {
    return (
        <div className="carousel w-full">
            <div id="slide1" className="carousel-item relative w-full bg-secondary text-primary py-20">
                {/* <img
                ...
                <div className='space-y-5 flex flex-col items-center md:items-start justify-center px-16 md:pl-32 md:py-20'>
                    ...
                    <Link to="/createGroup" className='btn bg-primary text-secondary flex gap-1 w-fit'>Apply</Link>
                </div>
            ...
            <div id="slide2" className="carousel-item relative w-full bg-secondary text-primary py-20">
                {/* <img
            ...
            <div id="slide3" className="carousel-item relative w-full text-primary bg-secondary py-20">
                {/* <img
                ...
                <div className='space-y-5 flex flex-col items-center md:items-start justify-center px-16 md:pl-32 md:py-20'>
                    ...
                    <Link to="/createGroup" className='btn bg-primary text-secondary flex gap-1 w-fit'>Subscribe</Link>
                </div>
                <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
                <a href="#slide2" className="btn btn-circle">❮</a>
                <a href="#slide1" className="btn btn-circle">❯</a>
