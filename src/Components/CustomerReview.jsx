...
const CustomerReview = () => {
    ...
    return (
        <div className='mb-8'>
            <h2 className="text-3xl md:text-4xl font-bold my-8 text-center">Members Reviews</h2>
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10'>
                {
                    reviews.map((card) => 
                    <div key={card.id} className="card w-96 xl:w-fit bg-secondary shadow-xl pt-10 mx-auto">
                        ...
                        <div className="card-body items-center text-center">
                            ...
                            <p className="font-light md:text-xl my-5">{card.review}</p>
                        </div>
                    </div> 
                    )
                }
